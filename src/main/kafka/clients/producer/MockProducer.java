...
public class MockProducer implements Producer {
     ...
     *        the user must call {@link #completeLast()} or {@link #errorLast(RuntimeException))} after {@link
     ...
     * 
     * Equivalent to {@link #MockProducer(Serializer, Serializer, Partition, boolean) new MockProducer(null, null, null,
     * autoComplete)}
     */
    ...
    public synchronized RecordSend send(ProducerRecord record, Callback callback) {
        ...
        Completion completion = new Completion(offset, send, result, callback);
    ...
    private static class Completion {
        ...
        public Completion(long offset, RecordSend send, ProduceRequestResult result, Callback callback) {
            this.send = send;
            this.offset = offset;
            this.result = result;
        ...
        public void complete(RuntimeException e) {
            result.done(e == null ? offset : -1L, e);
            if (callback != null)
