...
public class ConfigDef {
  ...
  public Map<String, Object> parse(Map<? extends Object, ? extends Object> props) {
    /* check that all the keys are really strings */
    for(Object key: props.keySet())
      if(!(key instanceof String))
        throw new ConfigException(key.toString(), props.get(key), "Key must be a string.");
    ...
    try {
      ...
      case INT:
        if(value instanceof Integer) {
          ...
          throw new ConfigException(name, value, "Expected value to be an number or string.");
        }
      case LONG:
        if(value instanceof Integer)
  ...
  public enum Type {
    STRING, INT, LONG, DOUBLE, LIST, CLASS;
  }
