...
public enum Errors {
  ...
  CORRUPT_MESSAGE(2, new CorruptMessageException("The message contents does not match the message CRC or the message is otherwise corrupt.")),
  ...
  MESSAGE_TOO_LARGE(10, new MessageTooLargeException("The request included a message larger than the max message size the server will accept.")),
